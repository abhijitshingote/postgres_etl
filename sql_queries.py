...
songplay_table_create = ("""create table if not exists songplays (songplay_id serial, start_time bigint, user_id int, level text, song_id text, artist_id text, session_id int, location text, user_agent text)
""")
...
time_table_create = ("""create table if not exists time (start_time numeric, hour int, day int, week int, month int, year int, weekday int)
""")
